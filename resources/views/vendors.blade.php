                        ...
                        <tbody>
                            @foreach ($vendors as $v)
                                <tr>
                                    ...
                                    <td>{{ $v->gender }}</td>
                                    <td>
                                        <button class="btn btn-primary btn-sm editBtn" data-id="{{$v->_id}}">Edit</button>
                                        <button class="btn btn-danger btn-sm deleteBtn" data-id="{{$v->_id}}">Delete</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="modal-body" id="response">
                <form id="addVendorForm" method="POST" action="{{route('vendor.create')}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Enter full vendor name" required autocomplete="off">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" maxlength="10" class="form-control" id="mobile" placeholder="Enter 10 digit mobile number" name="mobile" autocomplete="off">
                    </div>
                    <div class="mb-3">
                        <label for="city" class="form-label">City</label>
                        <input type="text" class="form-control" id="city" placeholder="Enter city name" name="city" autocomplete="off">
                    </div>
                    <div class="mb-3">
...
<div class="modal fade" id="editVendorModal" tabindex="-1" aria-labelledby="exampleModalLgLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
