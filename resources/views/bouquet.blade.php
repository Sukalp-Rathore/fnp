...
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-primary btn-sm infoBtn"
                                                data-id="{{ $b->_id }}">Info</button>
                                            <button class="btn btn-secondary btn-sm editBtn"
                                                data-id="{{ $b->_id }}">Edit</button>
                                            <button class="btn btn-warning btn-sm printBtn"
                                                data-id="{{ $b->_id }}">Receipt</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLgLabel">Create Bouquet</h6>
                ...
                <div class="modal-body">
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <input type="text" class="form-control mb-2" name="customer_name" placeholder="Customer Name"
                                autocomplete="off">
                            <input type="email" class="form-control mb-2" name="customer_email"
                                placeholder="Customer Email" autocomplete="off">
                            <input type="tel" maxlength="10" class="form-control mb-2" name="customer_phone"
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="file" class="form-control" id="bouquet_image" name="bouquet_image" accept="image/*"
                            required>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center mb-3">
                        <img id="bouquetImage" src="" alt="Bouquet Image" class="img-fluid"
    ...
    <!-- Modal to Show Bouquet Receipt -->
    <div class="modal fade" id="bouquetReceiptModal" tabindex="-1" aria-labelledby="bouquetReceiptModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="bouquetReceiptModalLabel">Bouquet Receipt</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        `;
                            ...
                            $('#bouquetDeliveryAddress').text(bouquet.delivery_address ||
                                'N/A');
            ...
            $(document).on('click', '.editBtn', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#editBouquetModalContent').html(
                            response); // Load the modal content dynamically
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            // Show the modal
                            $('#bouquetReceiptModal').modal('show');
                        } else {
                            toastr.error(response.message);
                        }
                    },
